...
M(f)),N(f)===!1&&(setTimeout(function(){c.trigger("conmanmplete")},0),g.clearIncomplete&&(n(),f=g.clearMaskOnLostFocus?[]:w().slice())),G(d,f,void 0,b))}}function _(a){var b=this;ma=!0,document.activeElement!==b&&g.showMaskOnHover&&b.inputmask._valueGet()!==x().join("")&&G(b,x())}function aa(a){//trigger change on submit if any
...
onconmanmplete:a.noop,//executes when the mask is conmanmplete and focus is lost
...
clearIncomplete:!1,//clear the conmanmplete input on blur
